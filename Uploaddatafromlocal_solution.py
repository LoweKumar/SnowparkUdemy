...
_ = session.sql("create or replace temp stage db1.public.mystage").collect()
...
copied_into_result = employee_local.copy_into_table("employee1", target_columns=['FIRST_NAME','LAST_NAME','EMAIL','ADDRESS','CITY','DOJ'], force=True,on_error="CONTINUE")
